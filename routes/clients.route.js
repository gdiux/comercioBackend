...
// CONTROLLER
const { getClients, createClient, updateClient, deleteClient, createClientWeb, nivelesClient, getClientId } = require('../controllers/clients.controller');
 ...
 *  GET CLIENT BY ID
=========================================================================*/
router.get('/by/:id', validarJWT, getClientId);
